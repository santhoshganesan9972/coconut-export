...
export default function MenuFinalCTA() {
  ...
  return (
    <section
      ...
      aria-label="Ready To Start Sourcing"
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          Ready To Start Your
          <br />
          <span className="text-[#D4A017]">Global Sourcing?</span>
        </motion.h2>
        ...
        >
          <a
            href="/rfq"
            onClick={() => trackOutboundClick({ type: "request_quote", label: "Menu Page Final CTA Submit RFQ" })}
          ...
          <a
            href="/contact"
            onClick={() => trackOutboundClick({ type: "schedule_consultation", label: "Menu Page Final CTA Contact Export Team" })}
