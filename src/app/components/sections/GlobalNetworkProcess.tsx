...
const steps = [
  {
    step: 1,
    title: "Farm Sourcing",
    description: "Premium coconuts hand-selected from certified partner farms across Tamil Nadu's prime coconut-growing regions.",
    icon: (
  ...
  },
  {
    step: 2,
    title: "Processing",
    description: "Hygienic processing at ISO 22000 and HACCP certified facilities. Products are cleaned, sorted, graded, and prepared to export standards.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.3} className="w-5 h-5">
  ...
  },
  {
    ...
    description: "Multi-stage quality inspection at farm intake, processing, and pre-shipment stages ensuring every batch meets export specifications.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.3} className="w-5 h-5">
  ...
  },
  {
    step: 4,
    title: "Shipment",
    description: "Container loading, freight coordination, and real-time tracking. We manage all logistics from our facility to your destination port.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.3} className="w-5 h-5">
  ...
  },
  {
    step: 5,
    title: "Documentation",
    description: "Complete export documentation package including Bill of Lading, Certificate of Origin, Phytosanitary Certificate, and customs clearance.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.3} className="w-5 h-5">
  ...
  },
  {
    step: 6,
    title: "Delivery",
    description: "Your shipment arrives at the agreed destination port with real-time tracking, complete documentation, and our team on standby for arrival support.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.3} className="w-5 h-5">
