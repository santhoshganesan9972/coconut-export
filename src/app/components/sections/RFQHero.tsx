        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full py-28 md:py-0">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                <span className="block max-w-4xl">Request A</span>
              ...
              >
                ...
                >
                  <span className="relative z-10">Submit Your RFQ</span>
                  <svg
                    aria-hidden="true"
            ...
            >
              <div className="absolute inset-0 rounded-[2px] overflow-hidden">
                ...
                >
                  <Image
                    src="/images/rfq-hero.jpg"
                    alt="Professional export consultation and team meeting — dedicated support for international bulk procurement"
                    fill
